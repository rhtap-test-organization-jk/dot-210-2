...
export IMAGE_URL=quay.io/rhtap-test-organization-jk/rhtap-qe:$CI_TYPE-$TAG
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/dot-210-2-gitops
